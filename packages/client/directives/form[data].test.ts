...
test.skip('form[data]: ignore when server side', function () {
...
test.skip('form[data]: ignore when there is no [data]', function () {
...
test.skip('form[data]: ignore when it does not <form>', function () {
...
test.skip('form[data]: append onSubmit event', function () {
