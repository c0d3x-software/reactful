import { FunctionRef, CallType } from './decorator/types'
...
export const historical: string[] = []
...
export function getModuleFunctions({ code, path }: Args): FunctionRef[] {
   // const args = `[a-zA-Z0-9,\\(\\)\\[\\]\\<\\>\\: ]`
   const functions = [] as FunctionRef[]
