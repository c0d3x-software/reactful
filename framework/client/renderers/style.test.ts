...
// import { env, Reactful } from "../../kernel";

// test('styler: ignore when no node or path ', function () {
...
// test('styler: ignore when is not an element ', function () {
//    const functional = { node: { type: () => null } }
//    const noNodeProps = styler(functional as any, '/')
//    expect(noNodeProps).toBe(noNodeProps)
// })

// test('styler: modular CSS as JSX same cached path', function () {
