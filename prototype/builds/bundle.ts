...
globalThis[GLOBAL_KEY].clients['/mnt/b/Repositorios/reactful/prototype/routes/forms/form'] = { off:false, tag:'form' }
...
globalThis[GLOBAL_KEY].clients['/mnt/b/Repositorios/reactful/prototype/routes/login'] = { off:false, tag:'login' }
